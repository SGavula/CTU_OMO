...
public class Refrigerator extends AbstractDevice {
    public Refrigerator(String type, int stateOfDevice, int durability, int defaultElectricityCons, int defaultWaterCons, int defaultGasCons, Documentation documentation) {
